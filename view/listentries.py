...
class ListTab(QWidget):
    ...
    def load_items(self):
        """Fills the table that shows the history entries with the stored entries"""
        self.model.clear()
    ...
    def set_up_table(self):
        """Sets up and formats the table that shows the history entries with the stored entries"""
    ...
    def resize_table(self):
        ...
        that shows the history entries with the stored entries based on its contents"""
